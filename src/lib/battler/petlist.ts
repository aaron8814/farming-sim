...
export const PETS: ICharacter[] = [
    ...
    { damage: 0, name: "furbat", attack: 5, health: 10, price: 10 },
    { damage: 0, name: "gryphon", attack: 5, health: 10, price: 10 },
    { damage: 0, name: "imp", attack: 5, health: 10, price: 10 },
    { damage: 0, name: "maiden", attack: 5, health: 10, price: 10 },
